...
from tf_dataset.TF_Dataloader import TF_dataloader
...
def main(opt):
    ...
    TF_dataloader_ = TF_dataloader('./data/coco/images/train2017','./data/coco/annotations/instances_train2017.json', 1, opt)
